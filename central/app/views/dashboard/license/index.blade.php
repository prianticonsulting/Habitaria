			...
			<div class="content-wrapper"> 
				...
				<li class="active" style="float:right">Bienvenido {{ $nombre }}</li>
				 ...
				 <div class="page-header">
					 <h1>Licencias<small>Colonias</small></h1>
                ...
                <table class="display table table-striped table-hover" id="table-2">
				 ...
				 @foreach($licenses as $row)
                    <tr>
                      ...
                      <td><a href="#" onclick="verCupon({{$row->id}})"><img src="{{asset('assets/images/cupon.jpg')}}" alt="Licencia" /></a></td>
                    </tr>
					@endforeach				
                  </tbody>
				  <tfoot>
						<tr>
						  ...
						  <th><input type="text" name="filter_colony" 		placeholder="Filtrar por Colonia" 			class="search_init" /></th>
...
function verCupon(cupon){
	...
	$( "#cupon-body" ).load( "{{ url('dashboard/license/cupon')}}/"+cupon );
	$('#CuponDialog').modal();
}				
