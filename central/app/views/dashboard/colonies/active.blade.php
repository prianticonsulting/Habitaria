			...
			<div class="content-wrapper"> 
				...
				<li class="active" style="float:right">Bienvenido {{ $nombre }}</li>
				 ...
				 <div class="page-header">
					 <h1>Colonias<small>Licencias</small></h1>
                ...
                <table class="display table table-striped table-hover" id="table-2">
				  ...
				  @foreach($colonies as $row)
                    <tr>
                      ...
                      <td><a href="{{URL::action('PromoController@index',$row->colony_id)}}"><button type="button" class="btn btn-default btn-xs">Generar licencia</button></a></td>
                    </tr>
					@endforeach					
                  </tbody>
				  <tfoot>
