    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1>CENTRAL HABITARIA</h1>
                <hr>
                <p>Administra tu colonia, colonia privada o edificio de departamentos</p>
                <a href="#" class="btn btn-primary btn-xl page-scroll">Registrate</a>
            </div>
        </div>
    </header>
    ...
    <div class="container">
            <div class="row">
              ...
              <div class="col-lg-4 text-center">
                    ...
                    <p><a href="mailto:your-email@your-domain.com">prianticonsulting@gmail</a>
                    </p><br><br><br>
