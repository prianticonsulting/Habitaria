...
(function ($) {
	...
	setTimeout(function() {
        ...
        window.initFloatchartDemo2 = function () {
			...
			data[0] = {label: "Inquietudes", data:Math.floor(Math.random() * 100) + 1};
			data[1] = {label: "Sugerencias", data:Math.floor(Math.random() * 100) + 1};
			data[2] = {label: "Quejas", data:Math.floor(Math.random() * 100) + 1};
			
            $.plot('#place1', Asunto, {
                colors: ["#ffa500", "#f87aa0", "#5bc0de", "#82b964", "#ccd600", "#f4cc13", "#8960a7", "#454b52", "#d24d33", "#f0ad4e"],
                series: {
                    pie: {
                        show: true,
                        stroke: {
        ...
        window.initFloatchartDemo2 = function () {
			...
			data[0] = {label: "Resueltos", data:Math.floor(Math.random() * 100) + 1};
			data[1] = {label: "Por Revisar", data:Math.floor(Math.random() * 100) + 1};
			data[2] = {label: "En Proceso", data:Math.floor(Math.random() * 100) + 1};
			
            $.plot('#place2', Status, {
                colors: ["#ccd600","#d24d33","#5bc0de","#ffa500", "#f87aa0", "#82b964", "#f4cc13", "#8960a7", "#454b52", "#f0ad4e"],
                series: {
                    pie: {
                        show: true,
                        stroke: {
        ...
        function inbox() {
            ...
            $('.delete').click(function (e) {
                ...
                if (toDelete === 0) {
                    showAlert('Debe Seleccionar un Mensaje!');
                    return;
                }
            ...
            $('.mark_read, .mark_unread').click(function (e) {
                ...
                var msg = $checked.length > 1 ? 'Mensajes' : 'Mensaje';
                var state = $(this).is('.mark_read') ? ' Leido' : ' No Leido';
                var info = $checked.length + ' ' + msg + ' Marcado como ' + state;
                showAlert(info);
            });
        ...
        if ($('#available-validations').length) {
            ...
            $("#available-validations").validate({
                ...
                messages: {
                    ...
                    date3: {
                        required: 'Ingrese alguna fecha en formato dd/mm/aaaa'
                    },
                    min: {
                        required: 'Ingrese algún texto'
                    },
                    max: {
                        required: 'Ingrese algún texto'
                    },
                    ...
                    digits: {
                        required: 'Ingrese algunos digítos'
                    },
                    number: {
                        required: 'Ingrese algún número'
                    },
                    minVal: {
            ...
            $('#checkout-form').validate({
                ...
                messages: {
                    ...
                    code: {
                        ...
                        digits: 'Sólo dígitos por favor'
                    },
                    address: {
                        required: 'Ingrese su dirección completa'
                    },
                    name: {
                        required: 'Ingrese el nombre en su tarjeta'
                    },
                    card: {
                        required: 'Ingrese el número de su tarjeta'
                    },
                    cvv: {
                        required: 'Ingrese CVV2',
                        digits: 'Sólo dígitos'
                    },
                    month: {
        ...
        if ($('#order-form').length) {
            $("#order-form").validate({
                ...
                messages: {
                    ...
                    interested: {
                        required: 'Seleccione el servicio que le interesa'
                    },
                    budget: {
                        required: 'Seleccione su presupuesto'
                    }
                },
    ...
    //Registration Form Validation
        if ($('#registrationLogin-form').length) {
            $("#registrationLogin-form").validate({
                ...
                messages: {
                    email: {
                        required: '<span style="color:#FF0000; font-size:11px; margin-left:15px; margin-top:1px;"> Por favor, ingrese un E-mail</span>',
                        email: '<span style="color:#FF0000; font-size:11px; margin-left:15px;  margin-top:1px;"> Ingrese una dirección VÁLIDA de email</span>',
                    },
                    password2: {
	...
	//Registration Form Validation
        ...
        if ($('#registration-form').length) {
            $("#registration-form").validate({
                ...
                messages: {
                    ...
                    password: {
                        required: 'Ingrese su contraseña',
						minlength: 'La logitud mínima es de 6 carácteres'
                    },
                    passwordConfirm: {
                    ...
                    name_street: {
                        required: 'Seleccione la calle donde vive'
                    },
                    name_floor: {
                        required: 'Seleccione el piso donde vive  '
                    },

                    num_house_or_apartment: {

                        required: 'Ingrese el número de su vivienda'
                    },
                    phone: {
                        required: 'Ingrese su número telefónico',
        ...
        if ($('#review-form').length) {
            $("#review-form").validate({
                ...
                messages: {
                    ...
                    review: {
                        required: 'Introduzca su opinión'
                    },
                    quality: {
                        required: 'Puntúa la calidad del producto'
                    },
                    reliability: {

                        required: 'Califica la fiabilidad del producto'
                    },
                    overall: {
                        required: 'Califica el producto'
                    }
                },
            ...
            $('#steps-wizard').validate({
                ...
                messages: {
					admin_name: {
					 ...
					 admin_phone: {
                        required: 'Introduzca su número de télefono',
						number	: 'Ingrese dígitos solamente.'
                    },
                    location2: {
                        required: 'Introduzca al menos un nombre de calle o piso de la colonia'
                    },
                    monthly_fee: {
                        required: 'Introduzca el monto correspondiente a la cuota mensual de pago de la colonia',
                        number: 'Ingrese dígitos solamente.'				
                    },
					email: {
                        required: 'Ingrese E-mail del vecino.',
                    },
                    phone: {
                        required: 'Ingrese su número telefónico'
                    },
                    country: {
                        required: 'Seleccione país'
                    },
                    state: {
                    ...
                    colony_name: {
                        required: 'Ingrese el nombre de su colonia'
                    },
                    urbanism_type: {
                        required: 'Seleccione el tipo de desarrollo'
                    },
                    urbanism_name: {
                        required: 'Ingrese el nombre del desarrollo'
                    },
                    code: {
                        required: 'Ingrese código',
                        digits: 'Sólo dígitos por favor'
	   ...
	   //Edit Form Validation colonia
      if ($('#colonia-wizard').length) {
		 $('#colonia-wizard').validate({
                // Rules for form validation
                rules: {					
                    country: {
                        required: true
                ...
                messages: {
					...
					amount: {
						required: 'Introduzca el monto a cobrar.',
						number: 'Ingrese dígitos solamente.'	
					},
					saldo: {
						required: 'Introduzca el monto del saldo deudor.',
						number: 'Ingrese dígitos solamente.'	
					},
					neighbor: {
						required:'Seleccione un residente.'
					}
                },
		 ...
		 //Edit Form Validation calles de colonia
      if ($('#calles-wizard').length) {
		 $('#calles-wizard').validate({
			 ignore: '',
			rules: {
					location2: {
						required: true
		 ...
		 //Edit Form Validation email invitaciones
      if ($('#emails-wizard').length) {
		 $('#emails-wizard').validate({
			// Rules for form validation
			ignore: '',
					rules: {
						email: {
	 ...
	 //Edit Form Validation categorias
      if ($('#form_categoria').length) {
		 $('#form_categoria').validate({
			rules: {
				...
				messages: {
					categoria: {
						required: 'Por favor, introduzca el nombre de la categoria.',
        ...
        $('.mark_read, .mark_unread').click(function (e) {
            ...
            var msg = $checked.length > 1 ? 'Mensajes' : 'Mensaje';
            var state = $(this).is('.mark_read') ? ' Leido' : ' unread';
            var info = $checked.length + ' ' + msg + ' Marcado como ' + state;
            showAlert(info);
        });
    ...
    function scrollToTop() {
        ...
        $('#read, #unread').click(function(e) {
            e.preventDefault();
            if ($(this).hasClass('mark_read')){
                var option = "read";
            }else{
                var option = "unread";
            }
             ...
             var data=[];
             var $checked = $('.mailinbox .checkbox:checked');
             var checkedList = $checked.length;
             if (checkedList == 0)
              {
                return false;
              }else{
                ...
                $.post('suggestion/mark_change',{ data : data, option : option  },function(respuesta) {
                    $(".badge").html(respuesta);
                });
              }
        ...
        $("#deleteSuggestion").click(function(e) {
             e.preventDefault();
             var data=[];
             var $checked = $('.mailinbox .checkbox:checked');
             var checkedList = $checked.length;
             if (checkedList == 0)
              {
                ...
                $.post('suggestion/delete',{ data : data },function(respuesta) {
                     $(".badge").html(respuesta);
                });
              }
        ...
        $("#updateSuggestion").click(function(e) {
            e.preventDefault();
            var titleSuggestion = $("#titleSuggestion").html();
            $.post('suggestion/udtate_suggestion',{ titleSuggestion : titleSuggestion },function(respuesta) {
                     $("#accordion > tbody").html(respuesta.html);
                     $(".badge").html(respuesta.data);
                });
        });
