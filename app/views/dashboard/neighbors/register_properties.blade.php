...
<div class="colorful-page-wrapper">
  ...
  <div class="center-block">
    <div class="login-block" >
		{{ Form::open(['route'=>'neighbor.store.properties','files'=>'true','class'=>'orb-form', 'id'=>'registration-form']) }}
			<div class="registerbox-neighbor">
				<center>
					...
					{{ Form::hidden('neighbor', $neighbor->id) }}
				...
				<center>
				<br>
				<p class="text-center"> <strong>{{ $neighbor->name }} {{ $neighbor->last_name }} </strong>  </p>
				<br>
				</center>
