...
<div class="colorful-page-wrapper">
  ...
  <div class="center-block">
    <div class="login-block" align="Center">
		{{ Form::open(['route'=>'neighbor.store_update_fam','files'=>'true','class'=>'orb-form', 'id'=>'registration-form']) }}
			...
			<div class="registerbox-neighbor">
				...
				<div class="row">
					<section class="col col-6">
						...
						<label class="input">
							{{ Form::text('firstname',$neighbor->name,['placeholder'=>'Nombre', 'required']) }}
						</label>
					</section>
					<section class="col col-6">
						  <label class="label">Apellido</label>
						<label class="input">
							{{ Form::text('lastname',$neighbor->last_name,['placeholder'=>'Apellido', 'required']) }}
						</label>
					</section>
				</div>
                    <section > 
						<label class="input"> <i class="icon-append fa fa-phone"></i>
							{{ Form::text('phone',($neighbor->phone != NULL)? $neighbor->phone : '', ['placeholder'=>'Teléfono', 'required']) }}
                        </label>
                    </section>
					<div class="row">
					<section class="col col-6">
						...
						<label class="input">
							{{ Form::text('Calle',$catalog->name,['disabled']) }}
						</label>
					</section>
					<section class="col col-6">
						  <label class="label">Casa</label>
						<label class="input">
							{{ Form::text('casa',$property->num_house_or_apartment,['disabled']) }}
