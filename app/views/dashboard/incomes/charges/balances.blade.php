...
<!--Smooth Scroll-->
	...
	<!--MainWrapper-->
		...
		<div class="page-header">
			 <h1>Saldos<small>Vecinos</small></h1>
          ...
          <div class="col-md-12  bootstrap-grid">
            <div class="powerwidget green" id="most-form-elements" data-widget-editbutton="false">
			  ...
			  <div class="panel panel-success">
                ...
                {{ Form::open(['route'=>'income.charge.save.balance','files'=>'true','class'=>'orb-form', 'id' => 'colonia-wizard', 'autocomplete' => 'off', 'onsubmit'=>' return validarData()']) }}
                <fieldset>
                    <section class="col col-2">
						<label class="label">Saldo</label>
						<label class="input"> <i class="icon-prepend fa fa-money"></i>
						  {{ Form::text('saldo','',['required', 'id'=>'saldo']) }}
						</label>
					</section>
                ...
                <footer>
					 <button style="float:right;" type="submit" class="btn btn-success">Establecer saldo</button>
                </footer>
