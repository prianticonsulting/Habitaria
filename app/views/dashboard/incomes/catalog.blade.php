...
<!--Smooth Scroll-->
	...
	<!--MainWrapper-->
		...
		<!--Breadcrumb-->
			<div class="breadcrumb clearfix">
			  <ul>
				...
				<li class="active">Categoria Ingresos</li>
		...
		<div class="page-header">
          <h1>Categoria<small>Ingresos</small></h1>
        </div>
					...
					<div class="powerwidget green" id="form-wizard" data-widget-editbutton="false">
					  ...
					  <div class="inner-spacer">
						<!--Messages-->
							...
							@endforeach
						<!--/Messages-->
						{{ Form::open(['route'=>'incomes.catalog.store','files'=>'true','class'=>'orb-form', 'id'=>'form_categoria', 'onsubmit'=>'return checkSubmit()']) }}
						  <div>
							<fieldset class="step-1">
							  <div class="row">
								<section class="col col-6">
									<header>Definir Nueva Categoria de Ingresos</header><br>  
								</section> 
								</div>
								<div class="row">
	   ...
	   <!-- New widget -->
		  ...
		  <div class="col-md-6 bootstrap-grid"> 
            ...
            <div class="powerwidget green" id="nestable-intro" data-widget-editbutton="false">
              <header>
                <strong>Categorias Ingresos</strong>
              </header>
              <div class="inner-spacer">
								...
								<tr> 
								 ...
								 <span id="nedit{{ $cata->id }}">{{ $cata->description }}</span>
								  ...
								  <center>
									...
									@if( $cata->description != 'Pago de cuota mensual')
