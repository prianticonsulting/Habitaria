  ...
  <!--MainWrapper-->
    ...
    <div class="page-header">
        ...
        <div class="row" id="powerwidgets">
          <div class="col-md-12 bootstrap-grid"> 
            ...
            <div class="powerwidget green" id="from-emails" data-widget-editbutton="false">
              <header>
                 <h2 id="titleSuggestion">Enviados</h2>
              </header>
        ...
        {{ Form::open(['route'=>'config.colony.send.email','files'=>'true', 'id'=>'emails', 'role' => 'from','class'=>'orb-form']) }}
                {{ Form::hidden('urbanism_id',$urbanism->id) }} 
                  ...
                  <div class="row">
                    <div class="col-md-1">
                      <div class="left-content">
                        <div class="list-group"> <a href="{{URL::route('config.colony.suggestion')}}" class="list-group-item "><i class="entypo-inbox"></i><b>Recibidos</b><span class="badge">{{ $count }}</span></a> <a href="{{URL::route('config.colony.suggestions.sent')}}" class="list-group-item active"><i class="entypo-paper-plane"></i><b>Enviados</b></a> <a href="{{URL::route('config.colony.suggestions.trash')}}"  class="list-group-item"><i class="entypo-trash"></i><b>Papelera</b></a> </div>
                      </div>
                    </div>
                    <div class="col-md-11">
