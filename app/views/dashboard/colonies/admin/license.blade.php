  ...
  <div class="center-block">
    <div class="login-block" >
	 <div class="powerwidget-ctrls"> <a href="{{URL::route('logout')}}" class="button-icon powerwidget-delete-btn"><h2><small><i class="icon fa entypo-cancel"></i></small></h2></a></div>
		{{ Form::open(['route'=>'license.store','class'=>'orb-form', 'id'=>'promo-form']) }}
			<center>
			        <header>
          <div class="image-block"><img src="{{asset('assets/index/images/ui-sam.png')}}" alt="User" /></div>
          Colonia {{Colony::where('id','=',Session::get('colonia'))->pluck('name')}}<small class="text-success"  style="font-weight:bold; font-size:14px;">Activar licencia</small>
		</header>
				<fieldset>
				<section>
				<center>
				...
				<label class="input">
					{{ Form::text('code','',['placeholder'=>'Ingrese código de licencia']) }}
				...
				<fieldset>
					<button type="submit" class="btn btn-default send_forgot">Activar Licencia</button>
                </fieldset>
