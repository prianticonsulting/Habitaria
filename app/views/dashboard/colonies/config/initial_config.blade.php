                       ...
                       <div class="row">
							...
							<label class="input"> 
								<div class="input-group">
									...
									{{ Form::text('colony_name','',['placeholder'=>'Nombre de la Colonia/Edificio','class'=>'form-control']) }}
								</div><!-- /input-group -->
							</label>
                          </section> 
						...
						<!-- <section class="col col-3">
							<label class="input">
								<div class="input-group">
									...
									{{ Form::text('urbanism_name','',['placeholder'=>'Nombre del desarrollo','class'=>'form-control','id' => 'urbanism_name']) }}
								</div>
							</label>
						</section>  -->	
					  </div><br>
