...
@section ('titlePage')
	HABITARIA - PANEL | Registro de Familiar
@stop
@section ('cssPage')
...
<!--Smooth Scroll-->
	...
	<!--MainWrapper-->
		...
		<!--Breadcrumb-->
			<div class="breadcrumb clearfix">
			  <ul>
				...
				<li class="active">Registro de Familiar</li>
		...
		<div class="page-header">
          <h1>Registro<small>Familiar</small></h1>
        </div>
            ...
            <div class="powerwidget green" id="most-form-elements" data-widget-editbutton="false">
              ...
              <div class="inner-spacer">
				<!--Messages-->
					...
					@endforeach
				<!--/Messages-->
				{{ Form::open(['route'=>'config.colony.familiar.store','files'=>'true','class'=>'orb-form', 'id'=>'registration-neighbor']) }}
        <fieldset>
				...
				<label class="textarea"> 
					<div class="row">
						<center>
							...
							@if($urbanism_type == 3)
								{{ Form::hidden('piso', $neighbor_properties->num_floor_id) }}
							@else
								{{ Form::hidden('calle', $neighbor_properties->num_street_id) }}
							@endif
							
							{{ Form::hidden('casa', $neighbor_properties->num_house_or_apartment) }}
						</center>				
						<fieldset>
							<section>
