...
(function ($) {
	...
	setTimeout(function() {
        ...
        $(document).ready(function () {
            ...
            if ($('#table-record').length) {
				
				 var oTable = $('#table-record').dataTable({
					 "aaSorting": [[ 0, "desc" ]],
                    "oLanguage": {
                        "sSearch": "Buscar por Columnas:"
                    }
        ...
        if ($('#steps-wizard').length) {
            $('#steps-wizard').validate({
                ...
                messages: {
                    ...
                    name_floor: {
                         required: 'Ingrese el número del Piso'
                     },
                    name_street: {
      ...
      if ($('#calles-wizard').length) {
		 $('#calles-wizard').validate({
			...
			rules: {
				...
				messages: {
					location2: {
						required: ' introduzca el nombre de las calles de la colonia.',
      ...
      if ($('#emails-wizard').length) {
		 $('#emails-wizard').validate({
			...
			ignore: '',
					...
					messages: {
						email: {
							required: ' Ingrese al menos un E-mail de un vecino.',
						}
					},
    ...
    function scrollToTop() {
        ...
        $("#updateSuggestion").click(function(e) {
            ...
            $.post('suggestion/update_suggestion',{ titleSuggestion : titleSuggestion },function(respuesta) {
